...
def model_inference(fetched_input):
    ...
    vader_analyzer2 = IntensityScorer()
    vader_analyzer2.load_model('../models/Intensity_model')
    print('intensity:',vader_analyzer2.get_predictions(extracted_phrase))
    intensity_prediction = vader_analyzer2.get_predictions(extracted_phrase)
